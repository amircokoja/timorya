...
namespace Timorya.Infrastructure.Migrations
{
    ...
    [Migration("20250912145400_Manage_Organization_Permission")]
    partial class Manage_Organization_Permission
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Timorya.Domain.Users.MemberInvitation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Timorya.Domain.Users.MemberInvitation", b =>
                {
                    b.HasOne("Timorya.Domain.Users.User", "InvitedByUser")
                        .WithMany()
